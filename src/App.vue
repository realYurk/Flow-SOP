<template>
  <div style="display:flex;flex-direction:column;height:100vh;overflow:hidden;background:var(--bg-base);color:var(--text-pri);">
    <TitleBar />
...
onMounted(async () => {
  // Apply theme FIRST — prevents dark flash when default is light
  store.initTheme()
  // Then load data
